...
const Postload = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!PcityName || !Pdate || !PTimeOne || !DcityName || !Ddate || !DTimeOne || !price || !equipment || !weight || !distance || !commodity) {
    ...
    return (
        <>
            ...
            <div className='min-h-screen'>
                <Link href={"loads/allloads"} className="bg-cyan-400 px-3 py-2 ml-5">All loads</Link>
