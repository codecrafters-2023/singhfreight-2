            ...
            <div className='bg-white' style={{ height: "70%", overflowY: "scroll" }}>
              ...
              <div className='flex justify-between px-5 items-center my-12'>
                <div className='flex flex-col'>
                  ...
                  <span className='text-lgm font-medium flex justify-end gap-1'><b>Date: </b> {loadDetail?.Pdate}</span>
                  <span className='flex justify-end gap-1'><b>Time:</b>{loadDetail?.PTimeOne}-{loadDetail?.PTimeTwo}</span>
                </div>
                ...
                <div className='flex flex-col w-52'>
                  ...
                  <span className='text-lgm font-medium flex justify-end gap-1'><b>Date:</b>{loadDetail?.Ddate}</span>
                  <span className='flex justify-end gap-1'> <b>Time:</b>{loadDetail?.DTimeOne}-{loadDetail?.DTimeTwo} </span>
                </div>
              </div>
                ...
                <TableContainer style={{ width: "60%" }}>
                  <Table>
                    <Tbody>
                      ...
                      <Tr>
                        <Td>Commodity</Td>
                        <Td><b>{loadDetail?.commodity}</b></Td>
                      </Tr>
                    </Tbody>
                  </Table>
                </TableContainer>
